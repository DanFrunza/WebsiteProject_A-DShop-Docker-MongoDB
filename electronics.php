...
<meta charset="UTF-8">
    ...
    <?php
    // Definirea filtrului pentru a selecta produsele din categoria Electronics
    $filter = ['categorie' => 'electronics'];
    $options = [];
    ...
    if (empty($products)) {
        echo "<p>Nu există produse în categoria Electronics.</p>";
    } else {
